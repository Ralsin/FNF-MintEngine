...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("MintEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("MintEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1";
		app.meta["company"] = "Ralsi";
		app.meta["file"] = "MintEngine";
		app.meta["name"] = "Friday Night Funkin': Mint Engine";
		app.meta["packageName"] = "com.ralsi.mintengine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Mint Engine",
			width: 1280,
			x: null,
			y: null,
		};
		...
		#elseif air
		app.window.title = "Friday Night Funkin': Mint Engine";
		#else
